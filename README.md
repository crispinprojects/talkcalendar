...
The advantage of using my own built-in speech synthesizer is that Talk Calendar can be compiled without any external speech synthesizer dependencies. I have investigated using the [espeak](https://espeak.sourceforge.net/) text-to-speech engine. One issue I had was with word pronouciations. For example, with the word "pilates" my word concatenation spynthesizer would you use a pronouciation consisting of the word sounds "pil+laa_teez". Try using espeak to say pilates.  With my diphone synthesizer I can replicate the component word sounds.
