...
{	
	...
	gtk_grid_attach(GTK_GRID(grid), check_button_speak_time,          2, 9, 1, 1);	
	gtk_grid_attach(GTK_GRID(grid), check_button_speak_event_words,   3, 9, 1, 1);
	gtk_grid_attach(GTK_GRID(grid), check_button_speak_event_number,  4, 9, 1, 1);	
