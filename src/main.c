...
static int m_talk_female_voice=0;
...
static void config_read()
{
	...
	m_talk_female_voice=g_key_file_get_integer(kf, "calendar_settings", "speak_female", NULL);;
...
void config_write()
{
	...
	g_key_file_set_integer(kf, "calendar_settings", "speak_female", m_talk_female_voice);
...
{     
	...
	if(m_talk_female_voice){
		command_str ="./flite -voice slt"; //female voice
	}
	else {
		command_str ="./flite";
	}
	...
	//check that flite exists locally
...
static void callbk_set_preferences(GtkButton *button, gpointer  user_data)
{
	...
	GtkWidget *check_button_speak_female=g_object_get_data(G_OBJECT(button), "check-button-speak-female-key");	
	...
	m_talk_female_voice=gtk_check_button_get_active (GTK_CHECK_BUTTON(check_button_speak_female));
...
{	
	...
	GtkWidget *check_button_speak_female;	
	...
	check_button_speak_female= gtk_check_button_new_with_label ("Female Voice");
	...
	gtk_check_button_set_active (GTK_CHECK_BUTTON(check_button_speak_female), m_talk_female_voice);	
	...
	g_object_set_data(G_OBJECT(button_set), "check-button-speak-female-key",check_button_speak_female);
	...
	gtk_grid_attach(GTK_GRID(grid), check_button_speak_female,      3, 8, 1, 1);
	
	gtk_grid_attach(GTK_GRID(grid), check_button_speak_time,          1, 9, 1, 1);	
	gtk_grid_attach(GTK_GRID(grid), check_button_speak_location,     2, 9, 1, 1);	
	gtk_grid_attach(GTK_GRID(grid), check_button_speak_event_number,  3, 9, 1, 1);	
