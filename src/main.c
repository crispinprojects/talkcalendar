...
#define CONFIG_DIRNAME "talkcal-gtk4-060"
#define CONFIG_FILENAME "talkcal-config-060"
...
static void callbk_about(GSimpleAction* action, GVariant *parameter, gpointer user_data)
{
	...
	gtk_about_dialog_set_version (GTK_ABOUT_DIALOG(about_dialog), "Version 0.6.2");
...
static void speak_time(gint hour, gint min) 
{
	...
	all_diphones =g_list_concat(word_to_diphones("the"),word_to_diphones("time"));
	all_diphones =g_list_concat(all_diphones,word_to_diphones("is"));	
    all_diphones =g_list_concat(all_diphones,word_to_diphones("pau"));
