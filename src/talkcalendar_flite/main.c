...
//====================================================================
// GTK4 Talk Calendar
// Flite API used. whereis libflite.a
// You need to install libflite1 for run time
// Use checkflite.sh or sudo apt install libflite1 
// For compilation:  sudo apt install flite1-dev
...
//cst_voice *register_cmu_us_awb(void); // Prof Alan W Black (awb)voice
//cst_voice *register_cmu_us_kal16(void);//Kevin A.Lenzo (kal) voice
cst_voice *register_cmu_us_rms(void); // Richard M Stallman (rms) voice
...
static void callbk_about(GSimpleAction * action, GVariant *parameter, gpointer user_data){
	...
	gtk_about_dialog_set_program_name(GTK_ABOUT_DIALOG(about_dialog), "Talk Calendar (Flite)");
